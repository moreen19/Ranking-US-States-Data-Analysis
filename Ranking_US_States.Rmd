...
**According to the multiple regression model the 5 metrics used have an adjusted R value of 0.6088 implying that the metrics used in the project account for 60% of the weight in determination of a states rank and the remaining factors only account for 40%**
...
**The three plots above derived from our simulation further confirms that economics is has more influence on the ranking of a state and its values are more correlated to the rank of a state.**\

**The plot on  education shows plots that are more widely distributed indicating the less correlation between its rank value and the overall rank of a state.**

**Correction data on the other had seems to have a significant influence and correlation with a states rank but not as much as economics.**
